  ...
  return (
    <div className="border border-lightDark rounded-[0.625rem]">
      ...
      <div className="flex flex-col xl:flex-row justify-between gap-4  p-[2.5rem]">
        ...
        <button className=" hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Let&apos;s Work</button>
        <button className=" hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Download</button>
        </div>
      </div>
    </div>
  );
