      ...
      <div className=" hidden lg:block animate-in fade-in zoom-in bg-background p-4 pt-0 pb-0 border-b border-b-superGray">
        <div className="flex justify-between mx-[41px] gap-8 items-center ">
          <div className="flex gap-[2.5rem] items-center">
            <div className="flex border-r border-r-black self-stretch h-[7.15rem]"></div>
          ...
          <div className="flex text-[16px] items-center  ">
            <p
              className={`hover:text-yellow-300 hover:rounded-tl-[0.75rem] cursor-pointer flex items-center px-[3.12rem] gap-2 border-r border-r-superGray self-stretch  font-[500] text-customGrayAlt2`}
            >
              Home
            </p>
            <p
              className={`hover:text-yellow-300  cursor-pointer flex items-center px-[3.12rem] gap-2 border-r border-r-superGray self-stretch  font-[500] text-customGrayAlt2`}
            >
              About Me
            </p>
            <p
            ...
            <p
              className={`hover:text-yellow-300  hover:rounded-tr-[0.75rem] cursor-pointer flex items-center px-[3.12rem] gap-2 self-stretch   font-[500] text-customGrayAlt2`}
            >
              Services
            </p>
          </div>
          <div className="flex items-center gap-[40px] select-none">
            <div className="flex gap-[2.5rem] items-center">
              <div className="text-2xl md:text-4xl font-extrabold uppercase text-white">
              <button className=" hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">contact me</button>
              </div>

              <div className="flex border-r border-black self-stretch h-[7.15rem]"></div>
            </div>
          </div>
        </div>
      </div>
